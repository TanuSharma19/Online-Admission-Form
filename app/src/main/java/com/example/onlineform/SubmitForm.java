...
public class SubmitForm extends AppCompatActivity {
    TextView name_1,name_2,name_3,name_4,name_5,name_6,name_7,name_8,name_9,name_10,name_11,name_12,name_13;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       name_3=findViewById(R.id.detail_3);
        ...
        documentReference.addSnapshotListener(this, (value, error) -> {
            ...
            name_13.setText(value.getString("Course you want to enroll in"));
        });
    }
