...
public class AdmForm extends AppCompatActivity {
    EditText stName,fName,mName,mdob,mPhn,add,skName,skName1,mMark1,mMark2;
    TextView mCourse,tStream;
    RadioGroup mSex;
    RadioButton mMale,mFemale,mOther;
    Spinner core4,mStream;
    Button mSubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adm_form);
       ...
       final int year=calendar.get(Calendar.YEAR);
        ...
        mdob.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog=new DatePickerDialog(AdmForm.this, (view, year1, month1, day1) -> {
                month1 = month1 +1;
      ...
      //for validation of name
        ...
        mSubmit.setOnClickListener(v -> {
            ...
            DocumentReference documentReference = fStore.collection("Form detail").document(userId);
